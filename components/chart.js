...
export default function Example() {
  ...
  // Generate year-month options (from 2022-01 to 2024-07)
  ...
  const filteredData = selectedDates.length
    ? data.filter((item) => selectedDates.includes(item.name))
    : data;
  ...
  return (
    <div>
      <div className="mb-6">
        <div className="text-xl font-semibold text-center my-10 text-black">
          Dashboard
        </div>
